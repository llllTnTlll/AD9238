...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_fifo_ddr_bridge_0_2_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_ddr_bridge_v1_0_M00_AXI is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_ddr_bridge_v1_0_M00_AXI;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_ddr_bridge_v1_0_M00_AXI is
  ...
  signal \r_awaddr_off_reg[22]_i_3_n_0\ : STD_LOGIC;
  signal \r_awaddr_off_reg[22]_i_3_n_1\ : STD_LOGIC;
  signal \r_awaddr_off_reg[22]_i_3_n_2\ : STD_LOGIC;
  signal \r_awaddr_off_reg[22]_i_3_n_3\ : STD_LOGIC;
  signal \r_awaddr_off_reg[22]_i_3_n_4\ : STD_LOGIC;
  signal \r_awaddr_off_reg[22]_i_3_n_5\ : STD_LOGIC;
  signal \r_awaddr_off_reg[22]_i_3_n_6\ : STD_LOGIC;
  signal \r_awaddr_off_reg[22]_i_3_n_7\ : STD_LOGIC;
  ...
  signal r_awvalid_i_2_n_0 : STD_LOGIC;
  signal \r_done_cnt[0]_i_1_n_0\ : STD_LOGIC;
  signal \r_done_cnt[1]_i_1_n_0\ : STD_LOGIC;
  signal \r_done_cnt[6]_i_2_n_0\ : STD_LOGIC;
  signal r_done_cnt_reg : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal r_inflight : STD_LOGIC;
  signal r_inflight_i_1_n_0 : STD_LOGIC;
  signal r_txn_done_i_1_n_0 : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \r_awaddr_off_reg[22]_i_3\ : label is 11;
  ...
  attribute SOFT_HLUTNM of \r_done_cnt[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_done_cnt[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_done_cnt[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \r_done_cnt[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \r_done_cnt[6]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of r_txn_done_i_1 : label is "soft_lutpair1";
begin
...
\r_awaddr_off[22]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\r_awaddr_off[22]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\r_awaddr_off_reg[22]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \r_awaddr_off_reg[18]_i_1_n_0\,
      CO(3) => \r_awaddr_off_reg[22]_i_3_n_0\,
      CO(2) => \r_awaddr_off_reg[22]_i_3_n_1\,
      CO(1) => \r_awaddr_off_reg[22]_i_3_n_2\,
      CO(0) => \r_awaddr_off_reg[22]_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \r_awaddr_off_reg[22]_i_3_n_4\,
      O(2) => \r_awaddr_off_reg[22]_i_3_n_5\,
      O(1) => \r_awaddr_off_reg[22]_i_3_n_6\,
      O(0) => \r_awaddr_off_reg[22]_i_3_n_7\,
...
r_awvalid_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5557FFFF"
    )
        port map (
...
\r_done_cnt[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\r_done_cnt[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\r_done_cnt[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\r_done_cnt[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
\r_done_cnt[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\r_done_cnt[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\r_done_cnt[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\r_done_cnt[6]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
r_inflight_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"74440000"
    )
        port map (
...
r_txn_done_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_ddr_bridge is
  port (
    m00_axi_wdata : out STD_LOGIC_VECTOR ( 63 downto 0 );
    m00_axi_awaddr : out STD_LOGIC_VECTOR ( 28 downto 0 );
    m00_axi_wvalid : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_ddr_bridge;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_ddr_bridge is
begin
u_axi_master: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_ddr_bridge_v1_0_M00_AXI
     port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_fifo_ddr_bridge_0_2,fifo_ddr_bridge,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "fifo_ddr_bridge,Vivado 2025.1";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_PARAMETER of m00_axi_aclk : signal is "XIL_INTERFACENAME M00_AXI_CLK, ASSOCIATED_BUSIF M00_AXI, ASSOCIATED_RESET m00_axi_aresetn, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo_ddr_bridge
     port map (
      m00_axi_aclk => m00_axi_aclk,
      m00_axi_aresetn => m00_axi_aresetn,
