...
(* CHECK_LICENSE_TYPE = "design_2_axi_null_slave_0_0,axi_null_slave,{}" *) (* CORE_GENERATION_INFO = "design_2_axi_null_slave_0_0,axi_null_slave,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=axi_null_slave,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_ID_WIDTH=1,C_ADDR_WIDTH=32,C_DATA_WIDTH=64}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
